...
def execute(filters=None):
    ...
    if filters.get('group_by') == 'Hour':
        ...
        if peak:
            message = _("Peak Hour: {0}:00 with {1} messages").format(peak['hour'], peak['messages'])
...
def get_columns(filters):
    ...
    if group_by == 'Date':
        return [
            ...
            {"fieldname": "total_messages", "label": _("Total Messages"), "fieldtype": "Int", "width": 120},
            {"fieldname": "unique_users", "label": _("Unique Users"), "fieldtype": "Int", "width": 120},
            {"fieldname": "tasks_created", "label": _("Tasks Created"), "fieldtype": "Int", "width": 120},
            {"fieldname": "errors", "label": _("Errors"), "fieldtype": "Int", "width": 120},
            {"fieldname": "avg_confidence", "label": _("Avg Confidence"), "fieldtype": "Float", "width": 120},
        ]
    else:  # Hour
        return [
